...
public class NotificationServiceAdapter implements INotificationPersistencePort {
    ...
    @Override
    public void sendNotification(String userId, String productName, String companyName) {
        notificationClient.saveProductNotification(userId, productName, companyName);
    }
}
